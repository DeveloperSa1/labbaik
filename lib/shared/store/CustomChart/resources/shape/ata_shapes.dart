...
class AtaShapes extends CompanyShapes {
  ...
  @override
  ShapeBorder get buttonShapeBorder => RoundedRectangleBorder(
      borderRadius: BorderRadius.all(Radius.circular(20)));

  @override
  ShapeBorder get cardShapeBorder => RoundedRectangleBorder(
      borderRadius: BorderRadius.all(Radius.circular(24)));

  @override
  ShapeBorder get chipShapeBorder => RoundedRectangleBorder(
      borderRadius: BorderRadius.all(Radius.circular(16)));

  @override
  ShapeBorder get legendBoxShapeBorder => RoundedRectangleBorder(
