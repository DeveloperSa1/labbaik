...
abstract class CompanyTextTheme {
  ...
  CompanyTextTheme(CompanyColors companyColors) {
    ...
    baseTextTheme =
        buildBaseTextTheme(colorScheme.onSurface, colorScheme.onSurface);
    primaryTextTheme =
        buildPrimaryTextTheme(colorScheme.onPrimary, colorScheme.onPrimary);
    secondaryTextTheme = buildSecondaryTextTheme(
