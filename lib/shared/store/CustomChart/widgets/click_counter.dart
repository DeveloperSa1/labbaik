...
import 'package:labbaik/shared/store/CustomChart/resources/colors/app_colors.dart';
      ...
      builder: (BuildContext context, int value, Widget? child) {
        return Column(
          children: [
            ...
            Text('$value',
                style: widget.textStyle.copyWith(color: _counterColor)),
            Padding(
              padding:
                  EdgeInsets.symmetric(vertical: AppDimens.SIZE_SPACING_SMALL),
