...
import 'package:labbaik/shared/store/CustomChart/resources/strings/app_strings.dart';
...
class BarChartLegend extends StatelessWidget {
        ...
        Flexible(
          ...
          child: Padding(
            padding: const EdgeInsets.symmetric(
                horizontal: AppDimens.SIZE_SPACING_2XS),
            child: Container(
              height: AppDimens.SIZE_SPACING_SM,
              decoration: ShapeDecoration(
                shape: shapes.legendBoxShapeBorder,
                color:
                    colors.heatmapColors.getColor(index / numberOfLegendBoxes),
              ),
            ),
          ),
        ),
  ...
  Widget _textLegend(
      String text, TextTheme textTheme, TextAlign textAlignment) {
    return SizedBox(
