...
class GuardianNotification extends StatelessWidget {
  GuardianNotification({Key? key}) : super(key: key);
              ...
              sizedH20,
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Row(
                    ...
                    children: [
                      PrimaryTabButton(buttonText: "تنبيهات الإداره", itemIndex: 0, notifier: _buttonTrigger),
                      PrimaryTabButton(buttonText: "طلباتي", itemIndex: 1, notifier: _buttonTrigger),
                    ],
                  ),
